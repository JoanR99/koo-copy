	...
	return (
		...
		>
			...
			<Stack spacing="26px">
				...
				>
					Established for over a decade, we are a team with great ideas, skills,
					and real-world experience in creating great games with an unrivaled
					experience. We harness the latest blockchain tools to craft
					exhilarating games that help you disrupt the market.
					<br />
					<br />
