        ...
        <Box>
            <Container sx={{
                ...
                <BoxCardsAll sx={{
                    ...
                    <BoxCard>
                        <CardMedia image={eclipse} component='eclipse' sx={{
                            width: '9.9375rem',
                            height: '9.9375rem'
                        }} />
                        <BoxLorem>
                            <TypographyLorem>
                                Lorem ipsum dolor sit amet consectetur. Orci massa orci diam orci tellus.
                            </TypographyLorem>
                        </BoxLorem>
                        <Box sx={{
                            display: {
                            ...
                            <CardMedia image={flecha1} component='flecha' sx={{
                                width: '14.65625rem',
                                height: '7.55rem',
                                flexShrink: 0,
                    ...
                    <BoxCard>
                        ...
                        <Box sx={{
                            ...
                            <CardMedia image={flecha2} component='flecha' sx={{
                                width: '14.78125rem',
                                height: '6.25rem',
                                // width: '14.65625rem',
                                // height: '7.55rem',
