...
import { IdividualCardTegnogoly } from "@/components/landingPage/individualCardTegnogoly/IdividualCardTegnogoly";

export const CardsTegnogoly = () => {
  const img = [
    {
      img: img1,
      width: "5.0625rem",
  ...
  return (
    ...
    >
      {img.map((image) => {
        ...
        return (
          <IdividualCardTegnogoly image={img} width={width} height={height} />
        );
      })}
    </ConteinerStyle>
  );
