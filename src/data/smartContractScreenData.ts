import SmartArch from '@/assets/Img/svg/smart_arch.svg';
import SmartDev from '@/assets/Img/svg/smart_dev.svg';
import SmartAud from '@/assets/Img/svg/smart_aud.svg';
import SmartOpt from '@/assets/Img/svg/smart_opt.svg';
...
export const blockchainsPlatforms = [
	{
		title: 'Ethereum SmartContract Development',
		description:
	...
	{
		title: 'TRON Smart ContractDevelopment',
		description:
	...
	{
		title: 'Hyperledger SmartContract Development',
		description:
	...
	{
		title: 'Binance Smart ContractDevelopment',
		description:
	...
	{
		title: 'EOS Smart ContractDevelopment',
		description:
	...
	{
		title: 'Polkadot Smart ContractDevelopment',
		description:
			'Our smart contract developers have the expertise to create smart contracts on Polkadot that can be used for a variety of use cases.',
		maxWidth: '366px',
	},
];
