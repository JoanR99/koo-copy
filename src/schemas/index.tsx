...
export const contanctUs = yup.object().shape({
  fullname: yup
    .string()
    .min(5, "User Name must be at least 5 characters long")
  ...
  phonenumber: yup
    .string()
    .matches(onlyNumber, "Phone number must be numeric")
    .required(`Required`),
  country: yup.string().required(`Require country`),
  message: yup
    .string()
    .min(5, "Message must be at least 5 characters long")
    .max(250, "Message must contain a maximum of 250 characters")
    .required(`required`),
});
